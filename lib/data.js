export const personalInfo = {
  ...
  // Summary paragraphs
  summary: [
    `I took an unconventional path to web development. I started learning to code 
      with C and C++, building data structures from scratch and implementing algorithms 
      like Minimax for game AI. It was challenging, but it taught me how computers 
      really work.`,
    `Then I discovered web development and fell in love with building things people 
      can actually see and use. Now I specialize in Next.js, React, and TypeScript —
      creating full-stack applications that are fast, intuitive, and reliable. 
      I’ve also been building Web3 apps with smart contracts, exploring how on-chain 
      systems can solve real-world problems like ownership and trust.`,
    `My systems programming background gives me an edge: I write more efficient code, 
      debug issues faster, and think about performance from the start. I'm not just 
      moving pixels around — I understand what's happening underneath.`,
    `I'm looking for my first role as a Full Stack Developer where I can learn from 
      experienced engineers, contribute to real products, and continue growing my skills.`,
...
export const skills = [
  ...
  { name: "Wagmi", level: 80, category: "web3" },
  { name: "Web3 Integration", level: 80, category: "web3" },
  ...
  // Systems
  { name: "C/C++", level: 50, category: "c/c++" },
];
